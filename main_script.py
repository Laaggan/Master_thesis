...
weights_path = "weights-{epoch:02d}-{val_mean_iou:.2f}.hdf5"
...
my_unet = unet(input_size=input_size, num_classes=4, learning_rate=0.01, drop_rate=0.2, metrics=[mean_iou, dice_coef])
